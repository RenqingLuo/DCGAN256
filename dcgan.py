...
parser.add_argument('--netG', default='checkpoints/netG.pth', help="checkpoints/netG.pth")
parser.add_argument('--netD', default='checkpoints/netD.pth', help="checkpoints/netD.pth")
...
dataroot = "/home/lrq/pytorch-book/chapter7-GAN生成动漫头像/data/"
...
# The dataset will download as a file nrunning_meanamed *img_align_celeba.zip*. Once
